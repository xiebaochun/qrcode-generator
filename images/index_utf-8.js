    ...
    addEvent("qrcodeform", "submit", function(event){
        ...
        if(object.getError().length){
            ...
            if(object.getString()){
				...
				var wk=$('wk').style.backgroundColor;
                if(wk.indexOf('rgb') != -1){
                    wk=wk.colorHex();
                }else{
                    wk=wk.colorRgb();
                ...
                var wkcolor=wk.replace('#','');
				
				var nk=$('nk').style.backgroundColor;
                if(nk.indexOf('rgb') != -1){
                    nk=nk.colorHex();
                }else{
                    nk=nk.colorRgb();
                ...
                var nkcolor=nk.replace('#','');
				var size = $("size").value.trim();
				var radio = $("radio").value.trim();
				var level = $("level").value.trim();
				var logo = $("logo").value.trim();
                
                var colorParam=(bgcolor.length==6 && fgcolor.length==6 && wkcolor.length==6 && nkcolor.length==6) ? '&bg='+bgcolor+'&fg='+fgcolor+'&wk='+wkcolor+'&nk='+nkcolor+'&size='+size+'&radio='+radio+'&level='+level+'&logo='+logo : '';
                
                var uri="api2.php?text=" + encodeURIComponent(object.getString())+colorParam;
...
(function($){
    ...
    $('#savepic').click(function(){
        ...
        location.href='savejpg.php?url='+encodeURIComponent(uri);
    })
})(jQuery)
